...
*.[0-9]*)
	...
	if test ! -f /home/mayank/ncurses-5.8/man_alias.sed ; then
cat >>/home/mayank/ncurses-5.8/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/mayank/ncurses-5.8/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/mayank/ncurses-5.8/man_alias.sed | sort -u`
	cf_target=`grep "^$cf_source" /home/mayank/ncurses-5.8/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/mayank/ncurses-5.8/man_alias.sed \
		< $i | sed -f /home/mayank/ncurses-5.8/edit_man.sed >$TMP
